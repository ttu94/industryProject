        ...
        <div class="col-md-4">
            <div class="panels panels-default panelsTwo">
                ...
                <div class="panels-body">
                    ...
                    <a href="abstractModule"><button class="moduleTwoButton">Read More</button></a>
                </div>
                <br>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="panels panels-default panelsTwo">
                ...
                <div class="panels-body">
                    ...
                    <a href="modulesOne"><button class="moduleTwoButton">Read More</button></a>
                </div>
                <br><br>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panels panels-default panelsFour">
                ...
                <div class="panels-body">
                    ...
                    <a href="abstractModule"><button class="moduleOneButton">Read More</button></a>
                </div>
                <br>
            </div>
        </div>
