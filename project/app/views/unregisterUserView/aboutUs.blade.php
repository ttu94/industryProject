    ...
    <div class="col-md-6">
        ...
        <div class="blocks">
            ...
            <p class="basicFontStyle" style="text-align: justify">
                ...
                <br><br>
                <a target="_blank" href="https://cjcneurostemcell.org/"><button class="btns4 greybrown2"> Click here to learn more about the Clem Jones Centre for Neurobiology and Stem Cell Research</button></a> <br>
            </p>
        </div>
        <!--NEXT BLOCK DOWN-->
...
<div class="container-fluid">
    ...
    <!--<div class="col-md-4">-->
    <!--    <div class="panel panel-default doctorPanel">-->
    <!--        <img class="doctorImage" alt="" src="images/emma.png" />-->
    <!--        <h3 style="text-align: center">Dr. Emma Watson</h3>-->
    <!--        <div class="panel-body basicFontStyle" style="text-align: justify">-->
    <!--            Minister Hermione Jean Granger (b. 19 September, 1979[1]) was a-->
    <!--            Muggle-born witch born to Mr and Mrs Granger, both dentists.-->
    <!--            Hermione was raised as a Muggle girl until, at age eleven,-->
    <!--            she learned that she was a witch and had been accepted into Hogwarts School of Witchcraft and Wizardry-->
    <!--            <br>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--</div>-->
