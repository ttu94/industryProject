...
@section('title')
    ...
    Module 9: Peripheral nerve regeneration
@endsection

@section('pageTitle')
    <!--NAME OF THIRD HEADER GOES HERE-->
    <!--THIS ALSO NEEDS TO BE TAKEN FROM DB-->
   <h4>Module 9: Peripheral nerve regeneration</h4>
@endsection
...
<div class="container-fluid"> 
    ...
    <div class="col-md-5">
      ...
      <a href={{ route("module_quiz_info", array("id" => Auth::user()->id, "quizNo" => "Module 9")) }} ><button class="btn darkgrey2">Begin Quiz >></button></a>
    </div>
