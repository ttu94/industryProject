...
//route to generate a certificate for overall result
Route::get('certificate/overall/{id}/{moduleNo}', array('as' => 'certificate.overall', 'uses' => 'PageController@Certificate'));
